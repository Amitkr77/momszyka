  ...
  return (
    <>
      <Head>
        ...
        />
        <meta name="theme-color" content="#f79e33" />
        <link
      ...
      <div className="flex flex-col min-h-screen bg-gradient-to-b from-amber-50 to-white dark:from-amber-900 dark:to-amber-800 font-['Lato'] text-amber-800 dark:text-amber-100 leading-relaxed overflow-x-hidden w-full">
        <main className="flex-grow">
          ...
          >
            ...
            <div className="relative z-10 container mx-auto px-4 sm:px-6 text-center py-16 sm:py-24">
              <motion.h1
                className="text-3xl sm:text-5xl lg:text-6xl font-['Playfair_Display'] font-extrabold text-white tracking-tight mb-4 sm:mb-6 drop-shadow-lg"
                variants={containerVariants}
              >
                Celebrating the Heart of Every Home
              </motion.h1>
              <motion.p
                className="text-base sm:text-xl max-w-3xl mx-auto text-white/90 mb-6 sm:mb-8 font-light px-2 sm:px-0"
                variants={containerVariants}
              >
              ...
              <motion.div variants={containerVariants}>
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                  <DialogTrigger asChild>
                    <motion.button
                      className="inline-flex items-center justify-center bg-amber-600 text-white text-base sm:text-lg font-medium px-7 sm:px-8 py-3 sm:py-4 rounded-full hover:bg-amber-700 shadow-lg"
                  ...
                  <DialogContent className="bg-amber-50 dark:bg-amber-900 rounded-2xl max-w-[90vw] sm:max-w-md mx-4 sm:mx-auto">
                    <DialogHeader>
                      <DialogTitle className="text-xl sm:text-2xl font-['Playfair_Display'] text-amber-800 dark:text-amber-100 flex items-center gap-2 sm:gap-3">
                    ...
                    <div className="flex flex-col gap-3 mt-4 sm:mt-6">
                      <motion.a
                        href="/subscribe"
                        className="inline-flex items-center justify-center text-center bg-amber-600 text-white rounded-full py-3 px-5 font-medium text-sm sm:text-base hover:bg-amber-700 transition-colors shadow-sm"
                        variants={buttonVariants}
                        whileHover="hover"
                        whileTap="tap"
                      >
                      ...
                      <motion.button
                        ...
                        className="inline-flex items-center justify-center text-center bg-amber-100 text-amber-800 hover:bg-amber-200 dark:bg-amber-800 dark:text-amber-100 dark:hover:bg-amber-700 rounded-full py-3 px-5 font-medium text-sm sm:text-base transition-colors shadow-sm"
                        variants={buttonVariants}
                        whileHover="hover"
                        whileTap="tap"
                      >
          ...
          <section
            id="about"
            className="py-8 sm:py-12 md:py-16 relative overflow-hidden bg-[#F9FAFB]"
          >
            <div className="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h2 className="text-3xl sm:text-5xl md:text-6xl font-['Playfair_Display'] font-bold text-[var(--color-new)] mb-3 sm:mb-4">
                  About Momszyka
                </h2>
              ...
              <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-8 sm:mb-12">
                ...
                <motion.div
                  ...
                  className="relative"
                >
                  <div className="absolute -inset-4 bg-gradient-to-br from-[#f25c41]/30 to-[#f79e33]/30 rounded-[3rem] blur-2xl" />
                  <div className="relative rounded-[1.5rem] sm:rounded-[2rem] overflow-hidden shadow-2xl aspect-[4/3]">
                    <Image
                ...
                >
                  <h3 className="text-2xl sm:text-4xl font-['Playfair_Display'] font-bold text-gray-900">
                    Our Mission
                  </h3>
                  ...
                  <div className="bg-gradient-to-r from-[#f25c41]/10 to-[#f79e33]/10 rounded-2xl p-4 sm:p-5 border-l-4 border-[#f25c41]">
                    <p className="text-sm sm:text-lg text-[#2D3A3A] font-['Yatra_One',_cursive] italic">
                  ...
                  <p className="text-lg sm:text-2xl font-['Playfair_Display'] font-bold text-[var(--color-new)]">
              ...
              >
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-['Playfair_Display'] font-bold text-center text-gray-900 mb-4 sm:mb-6">
                ...
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
                  {features.map((feature, index) => (
                    <motion.div
                      ...
                      whileHover={{ y: -8 }}
                      className="bg-white rounded-2xl p-4 sm:p-5 shadow-lg hover:shadow-2xl transition-all"
                    >
                      <div
                        className={`w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br ${feature.gradient} rounded-2xl flex items-center justify-center text-white mb-3 sm:mb-4`}
                      >
                        <feature.icon size={24} className="sm:hidden" />
                        <feature.icon size={32} className="hidden sm:block" />
                      </div>
                      <h4 className="text-lg sm:text-2xl font-['Playfair_Display'] font-bold mb-2 sm:mb-3 text-gray-900">
                        {feature.title}
                      </h4>
