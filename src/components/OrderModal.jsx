...
const OrderModal = ({ order, onClose }) => {
  ...
  //Build orderDetails for WhatsApp popup
  const getOrderDetails = () => {
    let price = order.price;
    if (order.hasPortions) price = order.price.half; // default to half
    if (order.hasVariants) price = order.price.veg; // default to veg
