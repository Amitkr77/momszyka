...
const FrequentOrders = ({ variant = "default" }) => {
  ...
  return (
    <section className={`py-16 px-4 sm:px-8 ${sectionBg}`}>
      <div className="max-w-[1400px] mx-auto">
        ...
        {isMenuVariant ? (
          ...
          <div className="text-center mb-8">
            <h2 className="text-5xl md:text-6xl font-bold mb-4 text-[#FF8F00] relative inline-block">
              Popular Orders
              <span className="absolute -bottom-2 left-1/2 -translate-x-1/2 flex gap-1">
                <span className="w-16 h-1 rounded-full bg-primary" />
        ...
        >
          <CarouselContent className="cursor-grab active:cursor-grabbing py-4">
          ...
          <CarouselPrevious className="left-2 sm:-left-4 z-10 bg-white/90 shadow-md hover:bg-white" />
          <CarouselNext className="right-2 sm:-right-4 z-10 bg-white/90 shadow-md hover:bg-white" />
        </Carousel>
        ...
        {!isMenuVariant && (
          <div className="flex justify-center mt-8">
            <Link href="/subscribe">
              <button className="group flex items-center gap-2 px-8 py-3 rounded-full font-bold text-sm bg-gray-900 text-white hover:bg-orange-500 shadow-md hover:shadow-lg transition-all duration-200 active:scale-95">
                View All Items
