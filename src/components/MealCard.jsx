    ...
    <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100 hover:shadow-md hover:-translate-y-1 transition-transform duration-200">
      <div className="p-6">
        ...
        <div className="flex items-start justify-between gap-3 mb-3">
          <h3 className="text-2xl font-serif font-bold text-gray-900 flex-1 min-w-0">
            {type}
          </h3>
          <div className="flex items-center gap-1.5 text-gray-500 bg-gray-100 px-3 py-1.5 rounded-full whitespace-nowrap flex-shrink-0">
        ...
        {/* Image */}
        <div className="relative h-48 w-full overflow-hidden rounded-xl mb-4 bg-gray-100 group">
          <Image
            src={image}
            alt={`${type} Meal`}
            width={600}
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {memoizedBadges.map((badge) => (
            <span
              key={badge.text}
              className="inline-flex items-center gap-1.5 text-new text-xs font-semibold bg-new/10 px-2.5 py-1 rounded-full border border-new/20"
            >
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <button
            ...
            className="bg-new hover:bg-primary text-white font-bold px-6 py-2.5 rounded-full"
          >
            Subscribe
          </button>
        </div>
